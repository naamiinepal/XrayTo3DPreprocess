...
from xrayto3d_preprocess import save_subjects_individual_dir
...
def bids_kits():
    kits_bids_csv = 'external/XrayTo3DPreprocess/workflow/ctpelvic1k/subjects/kits_subjects.csv'
    KITS_BIDS_BASEPATH = CTPELVIC1K_PATH/'raw'/'KITS19'/'BIDS'
    KITS19_RAW_IMG_BASEPATH = CTPELVIC1K_PATH/'raw'/'KITS19'/'img'
    KITS19_RAW_SEG_BASEPATH = CTPELVIC1K_PATH/'raw' / \
        'KITS19'/'seg'/'CTPelvic1K_dataset4_mask_mappingback'

    save_subjects_individual_dir(kits_bids_csv, KITS19_RAW_IMG_BASEPATH, KITS19_RAW_SEG_BASEPATH, KITS_BIDS_BASEPATH)    

def bids_msd():
    msd_bids_csv = 'external/XrayTo3DPreprocess/workflow/ctpelvic1k/subjects/msd_t10-subjects.csv'
    MSD_BIDS_BASEPATH = CTPELVIC1K_PATH/'raw'/'MSD-T10'/'BIDS'
    MSDT10_RAW_IMG_BASEPATH = CTPELVIC1K_PATH/'raw'/'MSD-T10'/'img'/'Task10_Colon'
    MSDT10_RAW_SEG_BASEPATH = CTPELVIC1K_PATH/'raw' / \
        'MSD-T10'/'seg'/'CTPelvic1K_dataset3_mask_mappingback'

    save_subjects_individual_dir(
    msd_bids_csv, MSDT10_RAW_IMG_BASEPATH, MSDT10_RAW_SEG_BASEPATH, MSD_BIDS_BASEPATH)

def bids_cervix():
    cervix_bids_csv = 'external/XrayTo3DPreprocess/workflow/ctpelvic1k/subjects/cervix_subjects.csv'
    ...
    save_subjects_individual_dir(cervix_bids_csv,CERVIX_RAW_IMG_BASEPATH,CERVIX_RAW_SEG_BASEPATH,CERVIX_BIDS_PATH)

def bids_abdomen():
    abdomen_bids_csv = 'external/XrayTo3DPreprocess/workflow/ctpelvic1k/subjects/abdomen_subjects.csv'
    ...
    save_subjects_individual_dir(abdomen_bids_csv, ABMDOMEN_RAW_IMG_BASEPATH, ABMDOMEN_RAW_SEG_BASEPATH, ABMDOMEN_BIDS_PATH)
        
def bids_clinic():
    clinic_bids_csv = 'external/XrayTo3DPreprocess/workflow/ctpelvic1k/subjects/clinic_subjects.csv'
    ...
    save_subjects_individual_dir(
        clinic_bids_csv, CLINIC_RAW_IMG_BASEPATH, CLINIC_RAW_SEG_BASEPATH, CLINIC_BIDS_PATH)
...
def bids_clinic_metal():
    ...
    save_subjects_individual_dir(clinic_metal_bids_csv,CLINIC_METAL_RAW_IMG_BASEPATH,CLINIC_METAL_RAW_SEG_BASEPATH,CLINIC_METAL_BIDS_PATH)
