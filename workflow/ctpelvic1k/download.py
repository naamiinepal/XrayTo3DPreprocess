...
def download_msdt10_raw():
    ...
    zip_dest = CTPELVIC1K_PATH / "zips" / "MSD-T10" / "img"
    extract_dest = CTPELVIC1K_PATH / "raw" / "MSD-T10" / "img"
...
def download_clinic_raw():
    ...
    zip_dest = CTPELVIC1K_PATH / "zips"
    mkdir_or_exist(zip_dest)
    extract_dest = CTPELVIC1K_PATH / "raw"
...
def download_cervix_raw():
    ...
    zip_dest = CTPELVIC1K_PATH / "zips" / "CERVIX" / "img"
    download_synapse(cervix_synapse_id, zip_filename, zip_dest, md5_hash)

    extract_dest = CTPELVIC1K_PATH / "raw" / "CERVIX" / "img"
...
def download_abdomen_raw():
    ...
    zip_dest = CTPELVIC1K_PATH / "zips" / "ABDOMEN" / "img"
    download_synapse(cervix_synapse_id, zip_filename, zip_dest, md5_hash)

    extract_dest = CTPELVIC1K_PATH / "raw" / "ABDOMEN" / "img"
    extractall(zip_dest / zip_filename, extract_dest)
...
def download_kits_raw():
    ...
    extract_dest = CTPELVIC1K_PATH / "raw" / "KITS19" / "img"
...
def download_colonog_raw():
    ...
    extract_dest = CTPELVIC1K_PATH / "raw" / "COLONOG" / "img"
    mkdir_or_exist(extract_dest)
